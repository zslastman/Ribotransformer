%run -i "src/0_0_rpy2plots.py"
%run -i "src/Parse/1_ribodataob.py"
# %run -i "src/Parse/2_load_esm.py"
# %run -i "src/Model/3b_convmodel_normdata.py"
# %run -i "src/Sketches/transformer_sketch.py"
%run -i "src/Model/4_transformernormdata.py"
